          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4 text-gray-400">
              <li className="flex items-start">
                ...
                <span className="text-sm md:text-base">Calle Barberos 23, 28001 Madrid, España</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm md:text-base">Lun-Vie: 9:00 - 20:00, Sáb: 10:00 - 18:00</span>
              </li>
            </ul>
          </div>
        </div>
