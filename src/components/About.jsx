        ...
        <div className="flex flex-col lg:flex-row gap-10 md:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-black border-4 border-amber-500 rounded-xl flex items-center justify-center rotate-12 overflow-hidden">
                <div className="text-center -rotate-12">
                  <p className="text-amber-500 font-bold text-4xl">2005</p>
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              En <span className="text-amber-500 font-bold">Barbería Deluxe</span>, no solo cortamos cabello, creamos experiencias. Fundada en 2005, nuestra barbería se ha convertido en un referente de estilo y tradición en el corazón de Madrid.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
              <div className="text-center">
                <p className="text-amber-500 font-bold text-3xl md:text-4xl">18+</p>
                <p className="text-white text-sm">AÑOS DE EXPERIENCIA</p>
              </div>
              <div className="text-center">
                <p className="text-amber-500 font-bold text-3xl md:text-4xl">15K+</p>
                <p className="text-white text-sm">CLIENTES SATISFECHOS</p>
              </div>
              <div className="text-center md:col-span-1 col-span-2">
                <p className="text-amber-500 font-bold text-3xl md:text-4xl">4</p>
