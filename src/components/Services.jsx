...
const Services = () => {
  const services = [
    ...
    {
      title: "Tratamiento Barba",
      description: "Recorte, diseño y cuidado completo de barba con productos especializados.",
      price: "30€",
      time: "40 min"
    },
    {
      title: "Corte + Barba",
      description: "Combo completo que incluye corte de cabello y tratamiento completo de barba.",
      price: "50€",
      time: "60 min"
    },
    {
      title: "Coloración",
      description: "Servicio de coloración profesional para cabello y barba con productos de alta calidad.",
      price: "45€",
      time: "60 min"
    },
    {
      title: "Tratamiento Capilar",
      description: "Hidratación y tratamiento profundo para el cabello con productos naturales.",
      price: "40€",
      time: "45 min"
    }
  ];
