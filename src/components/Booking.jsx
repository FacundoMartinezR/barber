...
const Booking = () => {
  ...
  const services = [
    { id: 1, name: "Corte Clásico", duration: "30 min" },
    { id: 2, name: "Afeitado Premium", duration: "45 min" },
    { id: 3, name: "Tratamiento Barba", duration: "40 min" },
    { id: 4, name: "Corte + Barba", duration: "60 min" },
    { id: 5, name: "Coloración", duration: "60 min" },
    { id: 6, name: "Tratamiento Capilar", duration: "45 min" }
  ];
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 md:mb-8">
              <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 md:p-6">
                ...
                <p className="text-gray-400 mb-1 text-sm md:text-base">Lunes - Viernes: 9:00 - 20:00</p>
                <p className="text-gray-400 mb-1 text-sm md:text-base">Sábados: 10:00 - 18:00</p>
                <p className="text-gray-400 text-sm md:text-base">Domingos: Cerrado</p>
              </div>
              <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 md:p-6">
                <h3 className="text-white text-base md:text-lg font-bold mb-2">Contacto</h3>
                <p className="text-gray-400 mb-1 text-sm md:text-base">Calle Barberos 23, Madrid</p>
                <p className="text-gray-400 mb-1 text-sm md:text-base">+34 91 123 45 67</p>
                <p className="text-gray-400 text-sm md:text-base">info@barberiadeluxe.com</p>
              </div>
            </div>
