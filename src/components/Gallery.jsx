...
const Gallery = () => {
  ...
  const galleryItems = [
    { id: 1, title: "Corte Clásico" },
    { id: 2, title: "Diseño de Barba" },
    { id: 3, title: "Afeitado Premium" },
    { id: 4, title: "Tratamiento Capilar" },
    { id: 5, title: "Coloración Profesional" },
    { id: 6, title: "Estilo Moderno" },
    { id: 7, title: "Corte Degradado" },
    { id: 8, title: "Arte Barberil" },
  ];
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          {galleryItems.map((item, index) => (
            ...
            >
              <div className="w-full h-full bg-gray-800 border-2 border-dashed flex items-center justify-center">
                <div className="text-center">
                  <span className="text-gray-500 block mb-4">Imagen de {item.title}</span>
        ...
        <div className="mt-8 flex justify-center overflow-x-auto pb-4">
          <div className="flex space-x-3 md:space-x-4">
            {galleryItems.map((item, index) => (
              ...
              >
                <div className="w-full h-full bg-gray-700 border border-gray-600 flex items-center justify-center">
